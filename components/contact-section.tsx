            ...
            {[
              ...
              return (
                <a 
                  key={i} 
                  href={item.href}
                  className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 text-sm text-slate-700 hover:border-sky-300 hover:bg-sky-50 transition-all group shadow-sm"
                >
